...
- **Explore & Discover**: Search for books using the Google Books API and discover new titles across
  various categories.
- **Personal Library**: Save your favorite books to "My Books" for offline access, powered by Room
  database.
...
- **Search & Filter**: Powerful search functionality helping you find exactly what you're looking
  for.
...
- **Dependency Injection**: [Hilt](https://developer.android.com/training/dependency-injection/hilt-android) - Standard DI
  library for Android.
- **Database**: [Room](https://developer.android.com/training/data-storage/room) - Robust local data
  persistence.
...
- **Image Loading**: [Coil](https://coil-kt.github.io/coil/compose/) - Lightweight image loading
  library.
- **Firebase**:
...
- **Data Persistence**: [DataStore](https://developer.android.com/topic/libraries/architecture/datastore) - Scalable
